...
def main():
    ...
    # maml = MAML(model, p['optimizer_params']['learning_rate'], allow_unused=True,allow_nograd=True)  ####  lr = Fast adaptation learning rate
    # model = maml.clone()
    ...
    # scheduler = get_scheduler(p, train_optimizer)
    # print(scheduler)
    ...
    for epoch in range(start_epoch, p['epochs']):
        ...
        # print('train loss: ', tr_batchlosses)
        # print('train metric: ', tr_batchmetric)
        
        # print('val loss: ', val_batchlosses)
        # print('val metric: ', val_batchmetric)
